...
//función para cerrar todas las ventanas existentes y sus hilos
        for (JFrame jFrame : l) {
    ...
    private void mostrarhilos() {
        //función para debug, muestra los hilos abiertos
